...
def obter_noticias():
    # CORREÇÃO: Alterado de /news para /latest conforme o padrão correto do NewsData.io
    url = f"https://newsdata.io/api/1/latest?apikey={NEWSDATA_API_KEY}&country=br&language=pt"
    try:
